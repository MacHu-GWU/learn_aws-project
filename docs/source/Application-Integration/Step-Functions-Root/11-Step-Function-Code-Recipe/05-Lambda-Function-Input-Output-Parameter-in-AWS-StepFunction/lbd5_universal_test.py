...
def test_lbd1_request_response():
    res = bsm.lambda_client.invoke(
        FunctionName=lbd_arn,
...
def test_lbd3_sfn_input_object():
    bucket = f"{bsm.aws_account_alias}-{bsm.aws_region}-data"
    key = "projects/tmp/fw2-1.pdf"
...
test_lbd1_request_response()
test_lbd3_sfn_input_object()
test_lbd4_sfn_exec_arn()
