...
.. code-block:: bash
    ...
    python3 -c "$(curl -fsSL https://raw.githubusercontent.com/MacHu-GWU/learn_aws-project/main/install.py)"
"""
...
dir_repo = dir_tmp.joinpath("learn_aws-project")
...
args = [
    "git",
    "clone",
    "https://github.com/MacHu-GWU/learn_aws-project",
    f"{dir_repo}"
]
subprocess.run(args)
...
args = [
    sys.executable,
    str(dir_tmp.joinpath("learn_aws-project", "build_fts_anything_dataset.py")),
]
subprocess.run(args)
